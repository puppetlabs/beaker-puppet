...
hosts.each do |host|
  ...
  create_remote_file(host, 'DigiCert_Trusted_Root2_G4.pem', DigiCertGlobalRootG2)
  on(host, 'chmod a+r /root/DigiCert_Trusted_Root2_G4.pem')
  on(host, 'cp -p /root/DigiCert_Trusted_Root2_G4.pem /etc/certs/CA/')
  on(host, 'rm /root/DigiCert_Trusted_Root2_G4.pem')
